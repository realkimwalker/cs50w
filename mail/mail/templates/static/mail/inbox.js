...
function view_email(id){
  ...
  .then(email => {
      ...
      // Archive/Unarchive element with button
...
function load_mailbox(mailbox) {
  ...
  // Get emails for selected mailbox and current user
  fetch(`/emails/${mailbox}`)
  .then(response => response.json())
  .then(emails => {
      // Loop through emails via forEach, creating a new div per email
